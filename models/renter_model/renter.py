...
class Renter(ABC):
    ...
    def __init__(self, renter_id: str, name: str, contact_info: str, username: str = None, password: str = None, active: bool = True):
        ...
        self.__active = active  # User account status (active/inactive)
